...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2023 at 08:29 PM
...
CREATE TABLE `uzenet` (
  ...
  `UzenetDatum` timestamp NULL DEFAULT NULL,
...
INSERT INTO `uzenet` (`UzenetId`, `UzenetLike`, `UzenetCim`, `UzenetDatum`, `UzenetSzoveg`) VALUES
(1, 0, 'Teszteles Valasz1', '2023-10-13 18:07:45', 'ASfdf');
...
--
-- Dumping data for table `uzenetiras`
--

INSERT INTO `uzenetiras` (`FelhasznaloNev`, `UzenetId`) VALUES
('asdfg', 1),
('asdfg', 2),
('asdfg', 3),
('asdfg', 4),
...
CREATE TABLE `valaszok` (
  ...
  `ValaszokDatum` timestamp NULL DEFAULT NULL,
  `ValaszLike` int(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `valaszok`
--

INSERT INTO `valaszok` (`UzenetId`, `FelhasznaloNev`, `Valaszok`, `ValaszokDatum`, `ValaszLike`) VALUES
(1, '', 'Teszteles1', '2023-10-12 21:00:00', 0);
...
--
ALTER TABLE `uzenet`
  ADD UNIQUE KEY `UzenetId_2` (`UzenetId`);
...
--
ALTER TABLE `uzenet`
  MODIFY `UzenetId` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `uzenetiras`
--
ALTER TABLE `uzenetiras`
  MODIFY `UzenetId` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `uzenet`
  ADD CONSTRAINT `uzenet_ibfk_1` FOREIGN KEY (`UzenetId`) REFERENCES `uzenetiras` (`UzenetId`);

--
-- Constraints for table `uzenetiras`
--
ALTER TABLE `uzenetiras`
  ADD CONSTRAINT `uzenetiras_ibfk_2` FOREIGN KEY (`FelhasznaloNev`) REFERENCES `felhasznalo` (`FelhasznaloNev`);
